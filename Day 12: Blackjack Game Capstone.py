...
def compare(user_score, computer_score):
  if user_score == computer_score:
    ...
    return "Winner, Winner, Blackjack Dinner!"
  elif user_score > 21:
...
def play_game():
  ...
  for _ in range(2):
    new_card = deal_card()
    user_cards.append(new_card) #or user_cards.append(deal_card())
    computer_cards.append(new_card) #or #or user_cards.append(deal_card())
